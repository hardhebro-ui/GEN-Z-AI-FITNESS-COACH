...
import { Download, RefreshCw, AlertTriangle, CheckCircle2, User, Target, Activity, Zap, Utensils, ShieldAlert, Instagram } from 'lucide-react';
    ...
    <div className="min-h-[100dvh] bg-zinc-950 text-white flex flex-col font-sans overflow-hidden">
        ...
        <div id="pdf-content-light" className="w-[800px] bg-white text-zinc-900 p-0 font-sans relative">
          ...
          <div className="h-[1120px] flex flex-col items-center justify-center relative overflow-hidden bg-zinc-950 text-white p-20 text-center">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <p className="text-neon text-[10px] font-black uppercase tracking-[0.4em] mb-[-2rem] font-display italic">Your AI Fitness Coach</p>
              <h1 className="text-7xl font-black uppercase italic tracking-tighter leading-none">
                fitin60<span className="text-neon">.ai</span>
              </h1>
            ...
            <div className="absolute bottom-20 left-0 right-0 flex flex-col items-center space-y-4">
              ...
              <div className="text-zinc-800 font-black text-xs uppercase tracking-widest">© {new Date().getFullYear()} fitin60.ai</div>
            </div>
          </div>
          ...
          <div className="min-h-[1120px] p-16 bg-white break-before-page relative">
            ...
            <div className="absolute bottom-8 left-16 right-16 flex justify-between items-center border-t border-zinc-100 pt-4 opacity-30">
              <span className="text-[8px] font-black uppercase tracking-[0.3em]">fitin60.ai • Profile Analysis</span>
          ...
          <div className="min-h-[1120px] p-16 bg-white break-before-page relative">
            ...
            {/* Footer Watermark */}
            <div className="absolute bottom-8 left-16 right-16 flex justify-between items-center border-t border-zinc-100 pt-4 opacity-30">
              <span className="text-[8px] font-black uppercase tracking-[0.3em]">fitin60.ai • Training Protocol</span>
          ...
          <div className="min-h-[1120px] p-16 bg-white break-before-page relative">
            ...
            {/* Footer Watermark */}
            <div className="absolute bottom-8 left-16 right-16 flex justify-between items-center border-t border-zinc-100 pt-4 opacity-30">
              <span className="text-[8px] font-black uppercase tracking-[0.3em]">fitin60.ai • Fueling Strategy</span>
          ...
          <div className="h-[1120px] p-20 bg-zinc-950 text-white flex flex-col items-center justify-center text-center break-before-page relative overflow-hidden">
            ...
            <div className="absolute bottom-20 left-0 right-0 opacity-10 pointer-events-none">
              <div className="text-[120px] font-black uppercase italic tracking-tighter whitespace-nowrap">FITIN60.AI • FITIN60.AI</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 pt-12 pb-72 md:px-12 md:pt-20 md:pb-96 custom-scrollbar relative">
        ...
        <div className="flex flex-col items-center gap-6 mb-12">
          <a 
            href="https://instagram.com/fitin60.ai" 
            target="_blank" 
